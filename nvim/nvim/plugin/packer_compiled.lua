...
_G.packer_plugins = {
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  ["tempus-themes-vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/tempus-themes-vim",
    url = "https://github.com/protesilaos/tempus-themes-vim"
  },
  ["wal.vim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/wal.vim",
